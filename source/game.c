...
int game()
{
	...
	while (1) {
		// Introduction
		type_it("Detective Jones had been on the trail of the notorious thief, known as the \"Midnight Bandit\", for months. \nThe thief had been targeting jewelry stores in the city, and had so far managed to evade capture. However, Jones had recently received a tip-off about the thief's next target - a high-end jewelry store on the outskirts of town.\n");
